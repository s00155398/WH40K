...
#include "Ork_Character_Shoota.h"

AOrk_Character_Shoota::AOrk_Character_Shoota()
{
...
//void AOrk_Character_Shoota::BeginPlay()
//{
	//SpawnOrkMeshProps(GetMesh());
//}

void AOrk_Character_Shoota::FireShoota(ACharacter* PlayerRef)
{
//	
...
//				World->GetTimerManager().SetTimer(FireDelayTimerHandle, this, &AOrk_Character_Shoota::ResetFire, 0.1f, false);
//			}
//			else
//			{
//				World->GetTimerManager().SetTimer(ReloadTimerHandle, this, &AOrk_Character_Shoota::Reload, 2.0f, false);
//			}
//		}
//	}
//	
...
void AOrk_Character_Shoota::HitByProjectile()
{
//	if (Health > 0)
//	{
...
//}
//
//void AOrk_Character_Shoota::UpdateHealth()
//{
//	Health -= Damage;
//	if (Health <= 0)
//	{
...
//}
//
//void AOrk_Character_Shoota::ResetFire()
//{
//	bCanFire = true;
//	GetWorldTimerManager().ClearTimer(FireDelayTimerHandle);
//}
//
//void AOrk_Character_Shoota::Reload()
//{
//	ammo = 30;
//	bCanFire = true;
